...
PointVisualizer::PointVisualizer(ros::Publisher &pub, string ns,
                                 string frame_id)
...
void PointVisualizer::addPoints(vector<Point> &points,
...
CorrespondenceVisualizer::CorrespondenceVisualizer(ros::Publisher &pub,
                                                   string ns, string frame_id)
    : pub(pub), ns(ns), frame_id(frame_id) {
...
void CorrespondenceVisualizer::addCorrespondences(
